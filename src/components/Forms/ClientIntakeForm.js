...
import { RegularInputBox, NumberInputBox, DatePicker, Selection, RadioButtons, RadioButtons2, RadioButtons3 } from '../InputBoxes/Index'
	...
	return (
		<div className='newPatient'>
			<div className='newPatient__header'>
				HIV Testing Services: Client Intake Form
			</div>
			...
			<div className='newPatient__row'>
				...
				<RegularInputBox
                    name="address"
                    label="Client's Descriptive Address"
                />
			</div>
            ...
            <p>*If client tests HIV negative, has an HIV Risk Assesment Score of 1 and above, or there is evidence of STI syndrome, recommend re-testing after 3 months</p>
